/*
  ...
  This is a fork of multisig02.js with the purpose generating a serialized
  public key that is then used to spend
*/
...
async function runTest() {
  try {
    ...
    const alicePubKeyStr = alicePubKey.toString('hex')
    console.log(`alicePubKeyStr: ${alicePubKeyStr}`)
    const bobPubKeyStr = bobPubKey.toString('hex')
    console.log(`bobPubKeyStr: ${bobPubKeyStr}`)
    const samPubKeyStr = samPubKey.toString('hex')
    console.log(`samPubKeyStr: ${samPubKeyStr}`)
